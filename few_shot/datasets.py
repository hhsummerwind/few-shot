...
class QMBDDataset(Dataset):
    ...
    def __getitem__(self, item):
        instance = io.imread(self.datasetid_to_filepath[item], as_gray=True)
    ...
    def index_subset(subset):
        ...
        subset_len = 0
        for root, folders, files in os.walk(DATA_PATH + '/{}/'.format(subset)):
        ...
        for root, folders, files in os.walk(DATA_PATH + '/{}/'.format(subset)):
            ...
            class_name = alphabet#'{}.{}'.format(alphabet, root.split('/')[-1])
